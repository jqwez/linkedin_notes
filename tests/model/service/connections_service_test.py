...
class ConnectionServiceTest(unittest.TestCase):
  ...
  def test_saves_new_connection(self):
    ...
    jeremy = self.connection_service.save_connection("jeremy", "linkedin.com/in/jeremyvasquez")
  ...
  def test_get_by_id(self):
    new_connection = self.connection_service.save_connection("jeremy", "linkedin.com/in/jeremyvasquez")
