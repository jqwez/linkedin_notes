...
class InteractionServiceTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    test_interaction = self.interaction_service.save_interaction(str(uuid4()), "test notes", datetime.now())
  ...
  def test_saves_new_interaction(self):
    ...
    test_interaction = self.interaction_service.save_interaction(str(uuid4()), "notes", datetime.now())
  ...
  def test_get_by_id(self):
    new_interaction = self.interaction_service.save_interaction(str(uuid4()), "notes", datetime.now())
