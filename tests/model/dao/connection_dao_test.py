...
class ConnectionDAOTest(unittest.TestCase):
   connection_service = ConnectionService(DatabaseFactory.new_connection(DatabaseFactoryEnum.DEV))
   ...
   def test_from_entry_returns_dao(self):
      return
      self.connection_service.new_connection("jeremy", "linkedin.com/in/jeremyvasquez")
